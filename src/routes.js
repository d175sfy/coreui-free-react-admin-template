...
const StoreAddresses = React.lazy(() => import('./views/dispatch/stores/storeAddresses/StoreAddress'));
...
const routes = [
  ...
  { path: '/dispatch/stores/storeAddresses/StoreAddress', name: 'Store Address', component: StoreAddresses }
